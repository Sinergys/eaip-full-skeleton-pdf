...
print("=" * 80)
if total_expected > 0:
    percentage = (total_filled * 100) / total_expected
    print(f"Всего заполнено: {total_filled}/{total_expected} полей ({percentage:.1f}%)")
else:
    print(f"Всего заполнено: {total_filled}/{total_expected} полей")
