...
#### 1. Root Duplicate
- **Original Path**: `ingest_data.db` (project root)
- **Type**: root_duplicate
...
#### 2. Skeleton Orphan
- **Original Path**: `eaip_full_skeleton/ingest_data.db`
...
#### 3. Oldest Backup
- **Original Path**: `backups/ingest_data_20251201_212246.db`
- **Type**: oldest_backup
...
- **Destination**: `quarantine/database_cleanup_20251208/` (from project root)
...
cp "quarantine/database_cleanup_20251208/ingest_data.db" "ingest_data.db"
```
